    ...
    var _getDefaultLiveQueryClient = (0, _asyncToGenerator2.default)(
      function* () {
        ...
        var _yield$Promise$all = yield Promise.all([
            _CoreManager.default.getUserController().currentUserAsync(),
        ...
        var sessionToken = currentUser
          ? currentUser.getSessionToken()
          : undefined;
        var liveQueryServerURL = _CoreManager.default.get(
          'LIVEQUERY_SERVER_URL',
        );
